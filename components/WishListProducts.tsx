            ...
            <table className="w-full border-collapse">
              <thead className="border-b">
                <tr className="bg-black/5">
                  ...
                  <th
                    className="p-2 text-left hidden md:table-
cell"
                  >
                    Status
                  </th>
...
hover-effect"
                        ...
                        {product?.images && (
                          <Link
                            ...
                            className="border rounded-md group hidden
md:inline-flex"
                          >
                            <Image
...
hoverEffect h-20 w-20 object-contain"
                            />
                          </Link>
                        )}
                      ...
                      <td className="p-2 capitalize hidden md:table-cell">
                        {product?.categories && (
                          <p
                            className="uppercase line-clamp-1 text-xs font-
medium"
                          >
        ...
        <div
          className="flex min-h-[400px] flex-col items-center justify-
center space-y-6 px-4 text-center"
        >
          <div className="relative mb-4">
            <div
              className="absolute -top-1 -right-1 h-4 w-4 animate-ping
