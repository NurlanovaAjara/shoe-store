...
items-center justify-between gap-5"
                        >
                          <div
                            className="flex flex-1 items-start gap-2 h-36
md:h-44"
                          >
                            {product?.images && (
                              <Link
...
overflow-hidden group"
                              >
                                <Image
                                  ...
                                  height={500}
                                  loading="lazy"
                                  className="w-32 md:w-40 h-32 md:h-40 object-
cover group-hover:scale-105 hover-effect"
                                />
                              </Link>
                            )}
                            <div
...
text-gray-500 hover:text-red-600 hover-effect"
                                      />
                                    </TooltipTrigger>
                                    <TooltipContent
...
between h-36 md:h-44 p-0.5 md:p-1"
                          >
                            <PriceFormatter
                ...
                <div>
                  <div className="lg:col-span-1">
                    <div
                      className="hidden md:inline-block w-full bg-white p-6
rounded-lg border"
                    >
...
cursor-pointer ${selectedAddress?._id === address?._id && "text-shop_dark_green"}`}
                ...
                <div
                  className="md:hidden fixed bottom-0 left-0 w-full bg-
white pt-2"
                >
